...
update_vendor_hash "lib/pelican-panel-php.nix" "pelican-panel.phpOut.composerRepository"
update_hash "lib/pelican-panel-js.nix" "pelican-panel.jsOut.yarnOfflineCache"
